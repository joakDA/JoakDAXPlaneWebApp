...
namespace JoakDAXPWebApp.Migrations
{
    ...
    [Migration("20210701183435_CreateLicenseInfoTable")]
    partial class CreateLicenseInfoTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoakDAXPWebApp.Entities.LicenseInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("LibraryName")
                        .IsUnique()
                        .HasDatabaseName("idx_library_name_unique");

                    b.HasIndex("LicenseName")
                        .HasDatabaseName("idx_license_name");

                    b.ToTable("license_info");
                });
